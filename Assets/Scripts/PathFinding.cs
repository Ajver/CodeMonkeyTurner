...
public class PathFinding : MonoBehaviour
{
    ...
    {
        gridSystem = new GridSystem<PathNode>(width, height, cellSize, (position) => new PathNode(position));
    ...
    {
        return FindPath(startPosition, endPosition, out int _pathLengts);
    }
    ...
    {
        return GetNode(gridPosition.x, gridPosition.z).IsWalkable();
    }

    public void SetIsWalkableGridPosition(GridPosition gridPosition, bool isWalkable)
    {
        GetNode(gridPosition.x, gridPosition.z).SetIsWalkable(isWalkable);
    }
